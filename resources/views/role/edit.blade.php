      ...
      <hr>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'commission_report.view', in_array('commission_report.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'weekly_margin_report.view', in_array('weekly_margin_report.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'time_clock_report.view', in_array('time_clock_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.time_clock_report.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'services_report.view', in_array('services_report.view', $role_permissions), 
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'expense.import', in_array('expense.import', $role_permissions), 
